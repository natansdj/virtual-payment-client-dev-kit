...
' QueryDR Data
drExists        = null2unknown(respParams("vpc_DRExists"))
multipleDRs     = null2unknown(respParams("vpc_FoundMultipleDRs"))
...
' 3-D Secure Data
verType        = null2unknown(respParams("vpc_VerType"))
verStatus      = null2unknown(respParams("vpc_VerStatus"))
token           = null2unknown(respParams("vpc_VerToken"))
verSecurLevel  = null2unknown(respParams("vpc_VerSecurityLevel"))
enrolled       = null2unknown(respParams("vpc_3DSenrolled"))
xid               = null2unknown(respParams("vpc_3DSXID"))
acqECI           = null2unknown(respParams("vpc_3DSECI"))
authStatus       = null2unknown(respParams("vpc_3DSstatus"))

Dim shopTransNo, authorisedAmount, capturedAmount, refundedAmount, ticketNumber
' AMA Transaction Data
shopTransNo     = null2unknown(respParams("vpc_ShopTransactionNo"))
authorisedAmount= null2unknown(respParams("vpc_AuthorisedAmount"))
capturedAmount  = null2unknown(respParams("vpc_CapturedAmount"))
refundedAmount  = null2unknown(respParams("vpc_RefundedAmount"))
ticketNumber    = null2unknown(respParams("vpc_TicketNo"))

Dim amaTransaction
' Define an AMA transaction output for Refund & Capture transactions
amaTransaction = (shopTransNo = "No Value Returned")
...
<html>
    ...
    <body>
        ...
        <table width="100%" border="2" cellpadding="2" bgcolor="#0074C4" ID="Table1">
            <tr>
...
Function getResponseDescription(txnResponseCode)
    ...
    Select Case txnResponseCode
        ...
        Case "No Value Returned"   
            getResponseDescription = "No Value Returned"
        Case Else  
...
Function get3DSstatusDescription(statusResponse)
    If statusResponse <> "" Then
        Select Case statusResponse
            ...
            Case "No Value Returned"   
                get3DSstatusDescription = "No Value Returned"
            Case Else 
