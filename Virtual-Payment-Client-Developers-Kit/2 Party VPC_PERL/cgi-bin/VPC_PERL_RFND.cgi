...
sub displayReceipt ($$$$$$$$$$$$$$$$$$$$$) {
    ...
    "        <tr bgcolor='#0074C4'>\n",
    "            <td colspan='2' height='25'><p><strong>&nbsp;Basic Refund Transaction Fields</strong></p></td>\n",
    "        </tr>\n",
    "        <tr>\n",
    ...
    if ($txnResponseCode ne "7" and $txnResponseCode ne "No Value Returned") { 
        ...
        "                <HR />\n",
        "                Fields below are additional fields for AMA functionality.<br /></font>\n",
        "            </td>\n",
        "        </tr>\n",
        "        <tr bgcolor='#0074C4'>\n",
...
# @param $responseCode String containing the 3DS status
#
# @return String containing the appropriate description
sub get3DSstatusDescription ($) {
    my ($statusResponse) = @_;
