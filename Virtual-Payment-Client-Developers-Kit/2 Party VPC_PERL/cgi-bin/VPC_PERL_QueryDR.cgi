...
# QueryDR Data
my $drExists        = null2unknown($respParams{'vpc_DRExists'});
my $multipleDRs        = null2unknown($respParams{'vpc_FoundMultipleDRs'});


# 3-D Secure Data
my $verType         = null2unknown($respParams{'vpc_VerType'});
my $verStatus       = null2unknown($respParams{'vpc_VerStatus'});
my $token            = null2unknown($respParams{'vpc_VerToken'});
my $verSecurLevel   = null2unknown($respParams{'vpc_VerSecurityLevel'});
my $enrolled        = null2unknown($respParams{'vpc_3DSenrolled'});
my $xid                = null2unknown($respParams{'vpc_3DSXID'});
my $acqECI            = null2unknown($respParams{'vpc_3DSECI'});
my $authStatus        = null2unknown($respParams{'vpc_3DSstatus'});
...
# @param $drExists contains the VPC Response value 'vpc_DRExists'
# @param $multipleDRs contains the VPC Response value 'vpc_FoundMultipleDRs'
#
sub displayReceipt ($$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$) {
    my ($title,
        $againLink,
    ...
    my $errorTxt = "";
    if ($txnResponseCode ne "0" or $txnResponseCode eq "No Value Example") {
        $errorTxt = "Error"
    }
    ...
    "        <tr><td colspan='2' align='center'><font color='#0074C4'>Fields above are the request values returned.<br/><hr/>\n",
    "            Fields immediately below are additional special fields for QueryDR functionality.</font><br/></td></tr>\n",
...
if ($drExists ne "N") {
    ...
    print
    "        <tr>\n",
    "            <td colspan='2' align='center'><font color='#0074C4'><hr/>Fields below are for a Standard Transaction.</font><br/></td>\n",
    "       </tr>\n",
    ...
    # only display the following fields if not an error condition
    if ($txnResponseCode ne "7" and $txnResponseCode ne "No Value Returned" and $drExists = "Y") { 
        ...
        # output this next section if a Refund or Capture receipt
        if ($amaTransaction eq "1") { 
        ...
        # output this next section if a standard 2 or 3-Party receipt
        } else { 
            print
            "        <tr>\n",
            "            <td colspan='2'><HR /></td>\n",
            ...
            "        <tr>\n",
            "            <td colspan='2' align='center' valign='middle'>\n",
            "                <font color='#00AA00'>The 3-D Secure values shown in green are used for Authentication informartion only</font>\n",
            "            </td>\n",
            "        </tr>\n";
            }
        }
