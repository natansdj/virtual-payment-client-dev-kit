...
private void Page_Load(object sender, System.EventArgs e)
{
   /*
    ...
    <code>
    string postData = "vpc_AccessCode=accessValue&vpc_Command=pay&vpc_Merchant=YourMerchantID&vpc_MerchTxnRef=someValue&vpc_Version=1&vpc_User=amaUser&vpc_Password=amaPassword";
    </code>
    ...
    */
    ...
    try
    {
        ...
        */
        ...
        Label_DRExists.Text     = responseParameters.ContainsKey("vpc_DRExists")?responseParameters["vpc_DRExists"].ToString():"Unknown";
        Label_MultipleDR.Text     = responseParameters.ContainsKey("vpc_FoundMultipleDRs")?responseParameters["vpc_FoundMultipleDRs"].ToString():"Unknown";
...
<table align="center" border="0" width="70%">
    ...
    <tr class='shade'>
        ...
        <td><asp:Label id=Label_DRExists runat="server"/></td>
    </tr class='shade'>
        <tr>
        <td align="right"><strong><em>Found Multiple Receipts:  </em></strong></td>
        <td><asp:Label id=Label_MultipleDR runat="server"/></td>
    </tr>
